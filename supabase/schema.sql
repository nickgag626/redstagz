-- Supabase schema for RedStagz trade portal MVP
...
create table if not exists public.trade_offers (
  ...
  yahoo_league_key text not null,
  yahoo_team_key text not null,
  from_manager_id uuid not null references public.managers(id) on delete restrict,
...
-- NOTE: In production, restrict to a specific user id.
