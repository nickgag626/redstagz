...
// One-time importer: hardcoded from Nick's keepers page paste (confirmed).
...
export async function POST(req: Request) {
  ...
  // 1) Fetch existing players by name/team (since we don't have yahoo_player_id yet)
  ...
  // 3) Upsert into my_roster_players (available = true)
